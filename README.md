...
O usuário acessa a tela de Configuração para ajustar o som ambiente e os apps bloqueados.
Retorna ao Dashboard Principal e clica em Iniciar Foco.
Caso tente fechar o app durante o ciclo, a tela de Tentativa de Saída é disparada.
Ao concluir o tempo, o usuário é direcionado para a tela de Relatório de Conquistas para visualizar sua recompensa (árvore plantada e tempo ganho).
